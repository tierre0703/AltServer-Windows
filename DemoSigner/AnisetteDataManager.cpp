...
id __cdecl ALTDeviceIDReplacementFunction()
{
	...
	auto deviceIDString = SignManager::instance()->serverID();
...
bool AnisetteDataManager::LoadDependencies()
{
	...
	fs::path internetServicesDirectoryPath(SignManager::instance()->internetServicesFolderPath());
	...
	fs::path applicationSupportDirectoryPath(SignManager::instance()->applicationSupportFolderPath());
