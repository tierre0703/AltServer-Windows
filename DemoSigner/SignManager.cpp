...
SignManager::SignManager() : _appGroupSemaphore(1)
{
}
...
//void SignManager::Start(HWND windowHandle, HINSTANCE instanceHandle)
//{
...
pplx::task<std::shared_ptr<Application>> SignManager::_InstallApplication(std::optional<std::string> filepath, std::shared_ptr<Device> installDevice, std::string appleID, std::string password)
{
...
pplx::task<std::shared_ptr<AppID>> SignManager::RegisterAppID(std::string appName, std::string bundleID, std::shared_ptr<Team> team, std::shared_ptr<AppleAPISession> session)
{
...
pplx::task<std::shared_ptr<AppID>> SignManager::UpdateAppIDAppGroups(std::shared_ptr<AppID> appID, std::shared_ptr<Application> app, std::shared_ptr<Team> team, std::shared_ptr<AppleAPISession> session)
{
...
pplx::task<std::shared_ptr<ProvisioningProfile>> SignManager::FetchProvisioningProfile(std::shared_ptr<AppID> appID, std::shared_ptr<Device> device, std::shared_ptr<Team> team, std::shared_ptr<AppleAPISession> session)
{
	return AppleAPI::getInstance()->FetchProvisioningProfile(appID, device->type(), team, session);
}

pplx::task<std::shared_ptr<Application>> SignManager::InstallApp(std::shared_ptr<Application> app,
	std::shared_ptr<Device> device,
	std::shared_ptr<Team> team,
...
void SignManager::ShowInstallationNotification(std::string appName, std::string deviceName)
{
...
fs::path SignManager::appDataDirectoryPath() const
{
...
fs::path SignManager::certificatesDirectoryPath() const
{
